<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" id="css" href="{{URL::asset('css/user_admin_login.css')}}">
        <link rel="stylesheet" type="text/css" id="css" href="{{URL::asset('css/logmsg.css')}}">
...
//后面传递一个随机参数，否则在IE7和火狐下，不刷新图片
  ...
  <tr ><td >
      ...
      <form name="form1" onSubmit="return CheckForm();" action="{{ route('login') }}" method="post">
          @csrf
  ...
  <tr>
    <td width="220"></td>
    <td width="40">AT:&nbsp;&nbsp;</td>
    <td width="120"><input name="name" type="username" id="username" style="width:100px; height:20px; background:#e9e6e6; font-size:12px; border:solid 1px #a0a0a0; color:#3b1b1b;" tabindex="1" value=""></td>
    <td width="40">PW:&nbsp;&nbsp;</td>
