    ...
    $.fn.createModal = function(options,callback) {
        ...
        return this.each(function() {
            ...
            var writeModal = function(_$this){
                ...
                if(getTitle){
                    $(modalContent).append(
                            "<div class='modal-title' control-move><table style='width:100%;height:30px;font-size:14px;'><tr><td class='top_left' style='font-size:14px;font-weight:bold;text-align:center;width:50%;'>" + _$this.attr("data-title") + "</td><td class='top_right' style='font-size:14px;font-weight:bold;text-align:center;width:50%;'>余数表</td></tr></table></div>"
                    );
                }//获取data-title的值
