...
if ( $o_type == 33 )
{
		$rate = $db->get_rate( 69, $_SESSION["uid".$c_p_seesion] );
		$ot = 69;
		$rate2 = $db->get_rate( 70, $_SESSION["uid".$c_p_seesion] );
		$o_type_ar = "69,70";
		$o_type_arr = explode( ",", $o_type_ar );
}
if ( $o_type == 36 )
{
		$rate = $db->get_rate( 71, $_SESSION["uid".$c_p_seesion] );
		$ot = 71;
		$rate2 = $db->get_rate( 72, $_SESSION["uid".$c_p_seesion] );
		$o_type_ar = "71,72";
		$o_type_arr = explode( ",", $o_type_ar );
}
...
for ( ;	$i < 6;	++$i	)
{
		echo "                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"40\"><div align=\"center\"> NO </div></td>\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">";
...
for ( ;	$i < 11;	++$i	)
{
		...
		if ( $ot == 69 || $ot == 71 )
		{
				...
				echo ",0,\$(this),";
				echo $rate2[$j][1];
				echo ",0);\" class=\"rate_set2 rate_color\" type=\"text\" style=\"width:50%;\" value=\"";
				echo $rate2[$j][1];
				echo "\" />\n                            <a style=\"\" onClick=\"UpdateRate(";
				echo $j;
				echo ",";
