...
echo "\" onclick=\"window.location.href='m_bz.php?o=37'\">五不中</button>\n                                &nbsp;\n                                <button id=\"rtm2\" class=\"";
echo $o_type == 38 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='m_bz.php?o=38'\">六不中</button>\n                                &nbsp;\n                                <button id=\"rtm3\" class=\"";
echo $o_type == 39 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='m_bz.php?o=39'\">七不中</button>\n                                &nbsp;\n                                <button id=\"rtm4\" class=\"";
echo $o_type == 40 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='m_bz.php?o=40'\">八不中</button>\n                                &nbsp;\n                                <button id=\"rtm5\" class=\"";
echo $o_type == 41 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='m_bz.php?o=41'\">九不中</button>\n                                &nbsp;\n                                <button id=\"rtm6\" class=\"";
echo $o_type == 42 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='m_bz.php?o=42'\">十不中</button></td>\n                              <td class=\"F_bold\">&nbsp;</td>\n                              <td class=\"F_bold\">&nbsp;</td>\n                              <td class=\"F_bold\">&nbsp;</td>\n                            </tr>\n                          </tbody>\n                        </table></td>\n                    </tr>\n                  </tbody>\n ";
