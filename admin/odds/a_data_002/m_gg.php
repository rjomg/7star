...
$rate = array( );
$x = array( "µ¥", "Ë«", "´ó", "Ð¡" );
$rate[0] = $db->get_rate( 63 );
$rate[1] = $db->get_rate( 64 );
$rate[2] = $db->get_rate( 65 );
$rate[3] = $db->get_rate( 66 );
$rate[4] = $db->get_rate( 67 );
$rate[5] = $db->get_rate( 68 );
...
echo "<s";
echo "pan id=\"ftm1\">¹ý¹Ø</span>ÙrÂÊÔOÖÃ";
echo "<s";
...
echo "O </div></td>\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">ÕýÂë1[ÖÐ]</div></td>\n<!--                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"44\">¿‚î~</td>-->\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">ÕýÂë2[²»ÖÐ]</div></td>\n<!--                        <td borderco";
echo "lor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"44\">¿‚î~</td>-->\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">ÕýÂë3[ÖÐ]</div></td>\n<!--                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"44\">¿‚î~</td>-->\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">Õ";
echo "ýÂë4[²»ÖÐ]</div></td>\n<!--                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"44\">¿‚î~</td>-->\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">ÕýÂë5[ÖÐ]</div></td>\n<!--                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"44\">¿‚î~</td>-->\n                        <td bordercolor=\"cccc";
echo "cc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">ÕýÂë6[²»ÖÐ]</div></td>\n<!--                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"44\">¿‚î~</td>-->\n                      </tr>\n                   ";
foreach ( $x as $i => $k )
{
