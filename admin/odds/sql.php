...
$rate[0] = $db->get_rate( 51, $_SESSION["uid".$c_p_seesion] );
$rate[1] = $db->get_rate( 52, $_SESSION["uid".$c_p_seesion] );
$rate[2] = $db->get_rate( 53, $_SESSION["uid".$c_p_seesion] );
$rate[3] = $db->get_rate( 54, $_SESSION["uid".$c_p_seesion] );
$rate[4] = $db->get_rate( 55, $_SESSION["uid".$c_p_seesion] );
$rate[5] = $db->get_rate( 56, $_SESSION["uid".$c_p_seesion] );
