...
echo '<style>.header a{color:#000;},header td{color:#000;}</style>';
echo "<s";
...
echo "  <tr>\n      <td><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n          <tbody>\n            <tr>\n              <td background=\"../images/tab_12.gif\" width=\"8\">&nbsp;</td>\n              <td align=\"center\" height=\"50\"><!-- 開始  -->\n                <div id=\"result\">\n                  <input name=\"fm33\" value=\"&lt;button onclick=show_win('AD0!888','AT0!888','D2kPUwVvVnQFMw5nVGY!888','500','30";
echo "'); class=button_a&gt;新增分公司&lt;/button&gt;\" type=\"hidden\">\n                  <table class=\"Ball_List Tab\" align=\"center\" bgcolor=\"ffffff\" border=\"0\" bordercolor=\"f1f1f1\" cellpadding=\"1\" cellspacing=\"1\" width=\"99%\">\n                    <tbody>\n                      <tr class=\"td_caption_1 header\">\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"50\"><div align=\"cen";
echo "ter\"> 在線 </div></td>\n                        ";
if ( $power == 6 )
{
...
echo "                        <td bordercolor=\"cccccc\" bordercolordark=\"#FFFFFF\" align=\"center\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\">分公司%</td>\n                        <td bordercolor=\"cccccc\" bordercolordark=\"#FFFFFF\" align=\"center\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\">公司%</td>\n                        <td bordercolor=\"cccccc\" bordercolordark=\"#FFFFFF\" align=\"center\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\">類型</td>\n";
echo "                        <td bordercolor=\"cccccc\" align=\"center\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\">註冊時間</td>\n                        <td bordercolor=\"cccccc\" align=\"center\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\">登錄次数</td>\n                        <td bordercolor=\"cccccc\" align=\"center\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\">停押</td>\n                        <td bordercolor=\"cccccc\" align=\"center\" bgcolor=\"#D";
echo "FEFFF\" nowrap=\"nowrap\">狀況</td>\n                        ";
if ( $power < 6 )
{
...
while ( $row = $db->fetch_array( $query ) )
{
		...
		echo $min <= 900 ? "<img src='../images/USER_1.gif'>" : "<img src='../images/USER_0.gif'>";
		echo " </div></td>\n                        ";
		if ( $power == 6 )
		{
		...
		echo "                                  <td nowrap=\"nowrap\" width=\"16\"><img src=\"../images/icon_21x21_del.gif\" height=\"14\" width=\"14\"></td>\n                                  <td nowrap=\"nowrap\" width=\"26\"><a href=\"delete_user.php?power=";
		echo $power."&id=".$row['user_id'];
