...
//后面传递一个随机参数，否则在IE7和火狐下，不刷新图片
  ...
  <tr ><td >
      ...
      <input name="login" type="hidden" id="login" value="AWBRPQNjBGEAOQ!888!888"><br><table align=center width="840" border="0" cellpadding="0" cellspacing="0" style="background:url('images/2_02.jpg') no-repeat;">
  <tr>
  ...
  <tr>
    ...
    <!-- <td align="right"><img id="yzm" src="img/rand_num.php" alt="看不清楚，換一張" align="absmiddle" style="cursor: pointer;" onClick="javascript:newgdcode(this,this.src);"></td>
    <td align="left"><input name="code" type="text" id="code" style="width:100px; height:20px; background:#e9e6e6; font-size:12px; border:solid 1px #a0a0a0; color:#3b1b1b;" tabindex="3" maxlength="6"></td> -->
    <td height=30  width="*">&nbsp;&nbsp;
...
<!--     <td background="images/2_02.jpg" width="280"></td>
    <td background="images/2_02.jpg" width="280"></td> -->
  </tr>
<!--   <tr>
    <td background="images/2_02.jpg" height="145"></td>
    <td background="images/2_02.jpg" ></td>
    <td background="images/2_02.jpg" ></td>
  </tr>
  <tr>
    <td background="images/2_02.jpg" height="145"></td>
