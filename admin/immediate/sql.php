...
$t2s = array( "二肖连[中]", "二肖连[不中]", "三肖连[中]", "三肖连[不中]", "四肖连[中]", "四肖连[不中]" );
...
echo "<s";
echo "elect class=\"zaselect_ste\" name=\"kithe\" onchange=\"change_plate('sql.php','";
echo $t1;
echo "','";
echo $t2;
echo "',\$(this).val())\">\n                                  ";
...
echo "dth=\"100%\">\n  <tbody><tr>\n    <td valign=\"top\"><input name=\"ffc1\" id=\"ffc1\" value=\"100\" type=\"hidden\">\n            <input name=\"ffc2\" id=\"ffc2\" value=\"0\" type=\"hidden\">\n\t\t\t<input name=\"ffc3\" id=\"ffc3\" value=\"0\" type=\"hidden\">\n\t\t\t\n\t\t\t\n\t\t\t\n\t\t\t<table id=\"tb\" class=\"Ball_List Tab\" align=\"center\" border=\"0\" bordercolor=\"f1f1f1\" cellpadding=\"1\" cellspacing=\"1\" width=\"99%\">\n                \t\t\t\t\t<tbody><tr>\n      ";
echo "                <td colspan=\"9\" bordercolor=\"cccccc\" align=\"center\" background=\"../images/tab_19.gif\" bgcolor=\"#F5FBFF\" height=\"28\" nowrap=\"NOWRAP\">\n<button id=\"rtm1\" ";
echo $t2 == "二肖连[中]" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='sql.php?t2=二肖连[中]&plate_num=";
echo $plate_num;
echo "'\">二肖连[中][";
echo $tongji_zc['二肖连[中]'] + 0;
echo "]</button>&nbsp; \n<button id=\"rtm1\" ";
echo $t2 == "二肖连[不中]" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='sql.php?t2=二肖连[不中]&plate_num=";
echo $plate_num;
echo "'\">二肖连[不中][";
echo $tongji_zc['二肖连[中]'] + 0;
echo "]</button>&nbsp; \n<button id=\"rtm1\" ";
echo $t2 == "三肖连[中]" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='sql.php?t2=三肖连[中]&plate_num=";
echo $plate_num;
echo "'\">三肖连[中][";
echo $tongji_zc['三肖连[中]'] + 0;
echo "]</button>&nbsp; \n<button id=\"rtm1\" ";
echo $t2 == "三肖连[不中]" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='sql.php?t2=三肖连[不中]&plate_num=";
echo $plate_num;
echo "'\">三肖连[不中][";
echo $tongji_zc['三肖连[中]'] + 0;
echo "]</button>&nbsp; \n<button id=\"rtm1\" ";
echo $t2 == "四肖连[中]" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='sql.php?t2=四肖连[中]&plate_num=";
echo $plate_num;
echo "'\">四肖连[中][";
echo $tongji_zc['四肖连[中]'] + 0;
echo "]</button>&nbsp; \n<button id=\"rtm1\" ";
echo $t2 == "四肖连[不中]" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='sql.php?t2=四肖连[不中]&plate_num=";
echo $plate_num;
echo "'\">四肖连[不中][";
echo $tongji_zc['四肖连[中]'] + 0;
...
if ( $imm )
{
		...
		foreach ( $imm as $i => $v )
		{
				...
				if ( $v['zf'] != 0 )
				{
						...
						echo $i."&urlname=sql&rate=".$rate[1]."&ts=".$sing['zfts_value']."&je=".$v['zf']."&t1=".$t1."&t2=".$t2."&plate_num=".$plate_num;
