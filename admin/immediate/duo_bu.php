...
if ( $_POST['btnSubmit'] == "下注" )
{
		...
		$db->get_feiorders( $_GET['plate_num'], "A", $_GET[t1], $_GET[t2], $_POST[x_o_type3], $_POST[x_orders_y], $_POST[x_orders_p], 0, $_POST[x_orders_t], 1, 1, 0, $url );
}
...
echo "                             <tr>\n                                <td width=\"2%\"><div align=\"center\"><img src=\"../images/tb.gif\" height=\"16\" width=\"16\"></div></td>\n                                <td class=\"F_bold\" width=\"70%\">多補</td>\n                                <td class=\"F_bold\" align=\"right\"><a  href=\"javascript:history.back(-1)\" target=\"content\"><img src=\"../images/icon_21x21_del.gif\" border=\"0\" he";
echo "ight=\"16\" width=\"16\"></a></td>\n                              </tr>\n                            </tbody>\n                          </table></td>\n                      </tr>\n                    </tbody>\n                  </table></td>\n                <td width=\"16\"><img src=\"../images/tab_07.gif\" height=\"30\" width=\"16\"></td>\n              </tr>\n            </tbody>\n          </table></td>\n      </tr>\n      <tr>\n      ";
...
echo "1\" method=\"post\" action=\"\">                   \n                    <tbody>\n\n\n                      <tr>\n                        <td align=\"center\" bgcolor=\"#E6F1F7\" width=\"58\">号码</td>\n                        <td align=\"center\" bgcolor=\"#E6F1F7\" width=\"135\"> 赔率</td>\n                        <td align=\"center\" bgcolor=\"#E6F1F7\" width=\"135\">退水</td>\n                        <td align=\"center\" bgcolor=\"#E6F";
echo "1F7\" width=\"135\">金额</td>\n                      </tr>\n                        ";
foreach ( $x as $v )
{
		$y = explode( ",", $v );
		...
		echo $y[0];
		echo "\" />\n                        <td align=\"center\" bgcolor=\"#FFFFFF\"><input name=\"x_orders_p[]\" class=\"input3\" id=\"bl_0\" value=\"";
		echo $y[1];
		echo "\" size=\"10\" type=\"text\"></td>\n                        <td align=\"center\" bgcolor=\"#FFFFFF\"><input name=\"x_orders_t[]\" class=\"input3\" id=\"ds_0\" value=\"";
		echo $y[2];
