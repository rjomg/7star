...
$t2s = array( "五不中", "六不中", "七不中", "八不中", "九不中", "十不中" );
...
echo "'bz.php',".$user_id.",".$oid.",'".$plate_num."','".$t1."','".$t2."'";
...
echo "r>\n                          </tbody>\n                        </table></td>\n                              <td class=\"F_bold\" width=\"12\">&nbsp;</td>\n                              <td width=\"179\" align=\"right\"><input name=\"bz\" type=\"hidden\" id=\"bz\" value=\"0\">\n                                ";
echo "<s";
echo "pan id=\"n\">";
echo $_SESSION["jishizhudanshuaxinshijian".$c_p_seesion];
echo "</span>秒\n                                ";
...
echo $t2 == "五不中" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='bz.php?t1=不中&t2=五不中&plate_num=";
echo $plate_num;
echo "'\">五不中[";
echo $tongji_zc['五不中'] + 0;
echo "]</button>&nbsp;\n                    <button id=\"rtm2\" ";
echo $t2 == "六不中" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='bz.php?t1=不中&t2=六不中&plate_num=";
echo $plate_num;
echo "'\">六不中[";
echo $tongji_zc['六不中'] + 0;
echo "]</button>&nbsp;\n                    <button id=\"rtm3\" ";
echo $t2 == "七不中" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='bz.php?t1=不中&t2=七不中&plate_num=";
echo $plate_num;
echo "'\">七不中[";
echo $tongji_zc['七不中'] + 0;
echo "]</button>&nbsp;\n                    <button id=\"rtm4\" ";
echo $t2 == "八不中" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='bz.php?t1=不中&t2=八不中&plate_num=";
echo $plate_num;
echo "'\">八不中[";
echo $tongji_zc['八不中'] + 0;
echo "]</button>&nbsp;\n                    <button id=\"rtm5\" ";
echo $t2 == "九不中" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='bz.php?t1=不中&t2=九不中&plate_num=";
echo $plate_num;
echo "'\">九不中[";
echo $tongji_zc['九不中'] + 0;
echo "]</button>&nbsp;\n                    <button id=\"rtm5\" ";
echo $t2 == "十不中" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='bz.php?t1=不中&t2=十不中&plate_num=";
echo $plate_num;
echo "'\">十不中[";
echo $tongji_zc['十不中'] + 0;
...
if ( $imm )
{
		...
		foreach ( $imm as $i => $v )
		{
				...
				if ( $v['zf'] != 0 )
				{
						...
						echo $i."&urlname=bz&rate=".$rate[1]."&ts=".$sing['zfts_value']."&je=".$v['zf']."&t1=".$t1."&t2=".$t2."&plate_num=".$plate_num;
