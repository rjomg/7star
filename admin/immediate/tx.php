...
$t2s = array( "特肖", "二肖", "三肖", "四肖", "五肖", "六肖", "一肖", "尾数" );
...
echo "<s";
echo "elect class=\"zaselect_ste\" name=\"kithe\" onchange=\"change_plate('tx.php','";
echo $t1;
echo "','";
echo $t2;
echo "',\$(this).val())\">\n                                  ";
...
echo "\"0\" width=\"100%\">\n  <tbody><tr>\n    <td valign=\"top\"><input name=\"ffc1\" id=\"ffc1\" value=\"10\" type=\"hidden\">\n            <input name=\"ffc2\" id=\"ffc2\" value=\"100\" type=\"hidden\">\n\t\t\t<input name=\"ffc3\" id=\"ffc3\" value=\"100\" type=\"hidden\">\n\t\t\t\n\t\t\t\n\t\t\t\n\t\t\t<table id=\"tb\" class=\"Ball_List Tab\" align=\"center\" border=\"0\" bordercolor=\"f1f1f1\" cellpadding=\"1\" cellspacing=\"1\" width=\"99%\">\n                \t\t\t\t\t<tbody><t";
echo "r>\n                      <td colspan=\"9\" bordercolor=\"cccccc\" align=\"center\" background=\"../images/tab_19.gif\" bgcolor=\"#F5FBFF\" height=\"28\" nowrap=\"NOWRAP\">\n\t\t\t\t\t  \t\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\t\t\n\t\t\t\t\n <button id=\"rtm1\" ";
echo $t2 == "特肖" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=特肖&plate_num=";
echo $plate_num;
echo "'\">特肖[";
echo $tongji_zc['特肖'] + 0;
echo "]</button>&nbsp;\n <button id=\"rtm1\" ";
echo $t2 == "二肖" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=二肖&plate_num=";
echo $plate_num;
echo "'\">二肖[";
echo $tongji_zc['二肖'] + 0;
echo "]</button>&nbsp;\n <button id=\"rtm1\" ";
echo $t2 == "三肖" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=三肖&plate_num=";
echo $plate_num;
echo "'\">三肖[";
echo $tongji_zc['三肖'] + 0;
echo "]</button>&nbsp;\n <button id=\"rtm1\" ";
echo $t2 == "四肖" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=四肖&plate_num=";
echo $plate_num;
echo "'\">四肖[";
echo $tongji_zc['四肖'] + 0;
echo "]</button>&nbsp;\n <button id=\"rtm1\" ";
echo $t2 == "五肖" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=五肖&plate_num=";
echo $plate_num;
echo "'\">五肖[";
echo $tongji_zc['五肖'] + 0;
echo "]</button>&nbsp;\n <button id=\"rtm1\" ";
echo $t2 == "六肖" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=六肖&plate_num=";
echo $plate_num;
echo "'\">六肖[";
echo $tongji_zc['六肖'] + 0;
echo "]</button>&nbsp;\n <button id=\"rtm1\" ";
echo $t2 == "一肖" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=一肖&plate_num=";
echo $plate_num;
echo "'\">一肖[";
echo $tongji_zc['一肖'] + 0;
echo "]</button>&nbsp;\n <button id=\"rtm1\" ";
echo $t2 == "尾数" ? "class=\"button_a1\"" : "class=\"button_a\"";
echo " onclick=\"window.location.href='tx.php?t2=尾数&plate_num=";
echo $plate_num;
echo "'\">尾数[";
echo $tongji_zc['尾数'] + 0;
...
if ( $imm )
{
		...
		foreach ( $imm as $i => $v )
		{
				...
				if ( $v['zf'] != 0 )
				{
						...
						echo $i."&urlname=tx&rate=".$rate[1]."&ts=".$sing['zfts_value']."&je=".$v['zf']."&t1=".$t1."&t2=".$t2."&plate_num=".$plate_num;
