...
function UpdateRate(oid,ty,th,oth,o,plate_num,t3){
    var thnew=th.val();
    var bl=chk_rat_is_n();
    if(!bl){
        return false;
    ...
    $.post("ajax_get_synchro_rate.php",{'o_id':oid,'t3':t3,'ty':ty,'oth':oth,'o':o,'thnew':thnew,'plate_num':plate_num},function (msg){
