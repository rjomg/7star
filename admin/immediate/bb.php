...
echo "bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"135\">賠率</td>\n                    </tr>\n\t\t\t</tr>\n\t\t\t";
$total = 0;
$zc = 0;
$yf = 0;
$zf = 0;
...
if ( $imm )
{
		...
		foreach ( $imm as $i => $v )
		{
				...
				if ( $v['zf'] != 0 )
				{
						...
						echo $i."&urlname=bb&rate=".$rate[1]."&ts=".$sing['zfts_value']."&je=".$v['zf']."&t1=".$t1."&t2=".$t2."&plate_num=".$plate_num;
