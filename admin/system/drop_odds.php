      ...
      <table width="100%" border="1" style="font-size:13px;text-align:left;" cellspacing="0" cellpadding="0" bordercolor="#000000" bordercolordark="#FFFFFF">
	    ...
	    for(i=0;i<qChArr.length;i++){
	      document.write('<input class="indw" type=button id=carTail'+i+' value='+qChArr[i]+' onclick="qChooseCar(2,2,'+i+');">');
		      ...
		      <button type="button" class="number_w">确定</button>
...
function write_td(no){   
  ...
  +'<tr align=center  height=30><td style="padding:0px;margin:0px;"><input type=hidden id=id'+no+' name=id'+no+'><div style="width:96%;text-align:center;" id=name'+no+'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>'
  +'<td style="padding:0px;margin:0px;"><font color=red face="Arial, Helvetica, sans-serif" style="font-size:15px;"><b><div style="width:94%;text-align:left;color:#oooooo;" id=rate'+no+'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></b></font><select style="padding:0px;margin:2px;"><option>开启</option><option>关闭</option></select></td></tr>'
  +'</table>'
  +'</td>';
  return h;
}
function show_t(){
 ...
 h='<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#000000" bordercolordark="#FFFFFF">'
  ...
  +"<td id='RowID_A1' onclick=BHry('EZ',1,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A2' onclick=BHry('EZ',2,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A3' onclick=BHry('EZ',3,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A4' onclick=BHry('EZ',4,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A5' onclick=BHry('EZ',5,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A6' onclick=BHry('EZ',6,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A7' onclick=BHry('EZ',7,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A8' onclick=BHry('EZ',8,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A9' onclick=BHry('EZ',9,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"<td id='RowID_A10' onclick=BHry('EZ',10,0) class='td1' height='6'><img src='../../member/picture/bhrow.gif'></td>"
  +"</TR>"
  +'<tr>';
...
for(i=0;i<100;i++){
  if (i%10 == 0) {
  	h+='<tr>';
  	h+="<td id='ColID_A"+num+"' class='td1' width='6' onclick=BHry('EZ',"+num+",1)><img src='../../member/picture/bhcol.gif'></td>";
  	num = num+1;
  }
...
function showdata(index,id,no,rate,money,frank_limit,shipanfrank){
  if (rate == ""){
  	...
  	rate='1';
  	if(95>0 && 95 > (shipanfrank-0))rate="<input style='width:45px;margin:2px;' type='text' value='"+rate+"'>"; else rate="<input style='width:45px;margin:2px;' type='text' value='"+rate+"'>";
