   ...
   <table border="0" cellpadding="0" cellspacing="0" class="tableborder" width="100%" style="table-layout: auto;">
    <tbody>
     ...
     <tr onmouseover="hover1(this);" onmouseout="hover2(this);" class="hover">
      ...
      <td class="reportmember content"><?php echo round($zj-$amount['order_y']+$tui['h_tui'],1);?></td>
      <?php if ($_GET['power']==5 || $_GET['power']==''){?>
      <td class="reportNow content"><?php echo $amount['order_y'];?></td>
      <td class="reportNow content"><?php echo round($zj-$amount['order_y']+$tui['d_tui']+$tui['h_tui'],1);?></td>
      <?php }?>
      <?php if ($_GET['power']==6){?>
      ...
      <td class="reportLevel content"><?php echo round($zj-$amount['order_y']+$tui['zd_tui']+$tui['d_tui']+$tui['h_tui'],1);?></td>
      <?php }?>
      <?php if ($_GET['power']==5){?>
      ...
      <td class="reportNow_z content"><?php echo round($zj-$amount['order_y']+$tui['gd_tui']+$tui['zd_tui']+$tui['d_tui']+$tui['h_tui'],1);?></td>
      <?php }?>
      <?php if ($_GET['power']==4){?>
      ...
      <?php if ($_GET['power']==2 || $_GET['power']==4 || $_GET['power']==''){?>
      <td class="reportLevel content"><?php echo $amount['order_y'];?></td>
      <td class="reportLevel content"><?php echo round($zj-$amount['order_y']+$tui['f_tui']+$tui['gd_tui']+$tui['zd_tui']+$tui['d_tui']+$tui['h_tui'],1);?></td>
      <?php }?>
      <?php if ($_GET['power']==3){?>
        <td class="reportLevel content"></td>
        <td class="reportLevel content"></td>
      ...
      <?php if ($_GET['power']==1 || $_GET['power']==3 || $_GET['power']==''){?>
      <td class="reportNow_z content"><?php echo $amount['order_y'];?></td>
      <td class="reportNow_z content"><?php echo round($amount['order_y']-$tui['h_tui']-$zj,1);?></td>
      <?php if ($_GET['power']==2){?>
      	<td class="reportNow_z content"></td>
      	<td class="reportNow_z content"></td>
      <?php }?>
	...
	<?php }?>	
     <tr class="reportFooter">
      ...
      <td class="content"><?php echo round($h_sy);?></td>
      <?php if ($_GET['power']==5 || $_GET['power']==''){?>
      <td class="content"><?php echo $huiyuan['zt'];?></td>
      <td class="content"><?php echo round($d_sy,1);?></td>
      <?php }?>      
      <?php if ($_GET['power']==6){?>
      	<td class="content"></td>
        <td class="content"></td>
      ...
      <?php if ($_GET['power']==4 || $_GET['power']==6 || $_GET['power']==''){?>
      <td class="content"><?php echo $huiyuan['zt'];?></td>
      <td class="content"><?php echo round($zd_sy,1);?></td>
      <?php }?>
      <?php if ($_GET['power']==5){?>
      	<td class="content"></td>
        <td class="content"></td>
      ...
      <?php if ($_GET['power']==3 || $_GET['power']==5 || $_GET['power']==''){?>
      <td class="content"><?php echo $huiyuan['zt'];?></td>
      <td class="content"><?php echo round($gd_sy,1);?></td>
      <?php }?>
      <?php if ($_GET['power']==4){?>
        <td class="content"></td>
        <td class="content"></td>
      ...
      <?php if ($_GET['power']==2 || $_GET['power']==4 || $_GET['power']==''){?>
      <td class="content"><?php echo $huiyuan['zt'];?></td>
      <td class="content"><?php echo round($f_sy,1);?></td>
      <?php }?>
      <?php if ($_GET['power']==3){?>
        <td class="content"></td>
        <td class="content"></td>
      ...
      <?php if ($_GET['power']==1 || $_GET['power']==3 || $_GET['power']==''){?>
      <td class="content"><?php echo $huiyuan['zt'];?></td>
      <td class="content"><?php echo round($g_sy,1);?></td>
      <?php if ($_GET['power']==2){?>
      	<td class="content"></td>
      	<td class="content"></td>
      <?php }?>
