...
$rate[0] = $db->get_rate( 63, $u_id );
$rate[1] = $db->get_rate( 64, $u_id );
$rate[2] = $db->get_rate( 65, $u_id );
$rate[3] = $db->get_rate( 66, $u_id );
$rate[4] = $db->get_rate( 67, $u_id );
$rate[5] = $db->get_rate( 68, $u_id );
$rate_c[0] = $db->get_rate( 63, $user_top['company']['user_id'] );
$rate_c[1] = $db->get_rate( 64, $user_top['company']['user_id'] );
$rate_c[2] = $db->get_rate( 65, $user_top['company']['user_id'] );
$rate_c[3] = $db->get_rate( 66, $user_top['company']['user_id'] );
$rate_c[4] = $db->get_rate( 67, $user_top['company']['user_id'] );
$rate_c[5] = $db->get_rate( 68, $user_top['company']['user_id'] );
