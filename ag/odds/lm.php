...
if ( $o_type == 33 )
{
		...
		$rate_c = $db->get_rate( 69, $user_top['company']['user_id'] );
		$ot = 69;
		$rate2 = $db->get_rate( 70, $u_id );
		$rate_c2 = $db->get_rate( 70, $user_top['company']['user_id'] );
		$o_type_ar = "69,70";
		$o_type_arr = explode( ",", $o_type_ar );
}
if ( $o_type == 36 )
{
		$rate = $db->get_rate( 71, $u_id );
		$rate_c = $db->get_rate( 71, $user_top['company']['user_id'] );
		$ot = 71;
		$rate2 = $db->get_rate( 72, $u_id );
		$rate_c2 = $db->get_rate( 72, $user_top['company']['user_id'] );
		$o_type_ar = "71,72";
		$o_type_arr = explode( ",", $o_type_ar );
}
...
echo "\" onclick=\"window.location.href='lm.php?o=32'\">二全中</button>\n                                &nbsp;\n                                <button id=\"rtm2\" class=\"";
echo $o_type == 33 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='lm.php?o=33'\">二中特</button>\n                                &nbsp;\n                                <button id=\"rtm3\" class=\"";
echo $o_type == 34 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='lm.php?o=34'\">特串</button>\n                                &nbsp;\n                                <button id=\"rtm4\" class=\"";
echo $o_type == 35 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='lm.php?o=35'\">三全中</button>\n                                &nbsp;\n                                <button id=\"rtm5\" class=\"";
echo $o_type == 36 ? "button_a1" : "button_a";
echo "\" onclick=\"window.location.href='lm.php?o=36'\">三中二</button></td>\n                              <td class=\"F_bold\">&nbsp;</td>\n                              <td class=\"F_bold\">&nbsp;</td>\n                              <td class=\"F_bold\">&nbsp;</td>\n                            </tr>\n                          </tbody>\n                        </table></td>\n                    </tr>\n                  </tbody>\n   ";
...
for ( ;	$i < 6;	++$i	)
{
		echo "                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\" width=\"25\"><div align=\"center\"> NO </div></td>\n                        <td bordercolor=\"cccccc\" bgcolor=\"#DFEFFF\" nowrap=\"nowrap\"><div align=\"center\">";
...
for ( ;	$i < 11;	++$i	)
{
		...
		echo ",";
		echo ( double )$rate[$j][1];
		echo ",0);\" class=\"rate_set rate_color\" type=\"text\" style=\"";
		...
		if ( $ot == 69 || $ot == 71 )
		{
				...
				echo ",";
				echo ( double )$rate2[$j][1];
				echo ",0);\" class=\"rate_set2 rate_color\" type=\"text\" style=\"width:25%;\" value=\"";
				echo ( double )$rate2[$j][1];
				echo "\" />\n                            <a style=\"\" onClick=\"UpdateRate(";
				echo $j."00";
				echo ",";
