...
$rate[0] = $db->get_rate( 51, $u_id );
$rate[1] = $db->get_rate( 52, $u_id );
$rate[2] = $db->get_rate( 53, $u_id );
$rate[3] = $db->get_rate( 54, $u_id );
$rate[4] = $db->get_rate( 55, $u_id );
$rate[5] = $db->get_rate( 56, $u_id );
$rate_c[0] = $db->get_rate( 51, $user_top['company']['user_id'] );
$rate_c[1] = $db->get_rate( 52, $user_top['company']['user_id'] );
$rate_c[2] = $db->get_rate( 53, $user_top['company']['user_id'] );
$rate_c[3] = $db->get_rate( 54, $user_top['company']['user_id'] );
$rate_c[4] = $db->get_rate( 55, $user_top['company']['user_id'] );
$rate_c[5] = $db->get_rate( 56, $user_top['company']['user_id'] );
