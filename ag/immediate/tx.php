...
if ( $imm )
{
		...
		foreach ( $imm as $i => $v )
		{
				...
				if ( $v['zf'] != 0 )
				{
						...
						echo $i."&urlname=tx&rate=".$rate[1]."&ts=".$sing['zc_value']."&je=".$v['zf']."&t1=".$t1."&t2=".$t2."&plate_num=".$plate_num;
