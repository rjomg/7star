var Html_SB="<html>";
Html_SB+="<head>";
Html_SB+="    <meta http-equiv='Content-Type' content='text/html; charset=utf-8' />";
...
Html_SB+="</body>";
Html_SB+="</html>";
var SB_Limit_Time=0;//ÏÞÑu•rég

var s_LT=1;//ßx“ñß[‘òîÐÍ
...
if (LT==1 && LT1==1){Limit_URL('ma8f2a4c2f698f2a4c2f6983f28f2a4c2f6983f2880d32e880d32e83f2880d32ein.jsp?action=pznfasdfasf79sd64643gfjmjkhsf1sklfsnnz_tm&ids=µÚÒ»Çò&lx36=6');}
if (LT==2 && LT1==1){Limit_URL('ma8f2a4c2f698f2a4c2f6983f28f2a4c2f6983f2880d32e880d32e83f2880d32ein.jsp?action=pznfasdfasf79sd64643gfjmjkhsf1sklfsnnz_tm1&ids=µÚÒ»Çò&lx36=1');}	


if (LT==1 && LT1==6){Limit_URL('ma8f2a4c2f698f2a4c2f6983f28f2a4c2f6983f2880d32e880d32e83f2880d32ein.jsp?action=ranfasdfasf79ssdfffjmsdjkhsf1sklfske_tm&ids=µÚÒ»Çò&lx36=6');}
if (LT==2 && LT1==6){Limit_URL('ma8f2a4c2f698f2a4c2f6983f28f2a4c2f6983f2880d32e880d32e83f2880d32ein.jsp?action=ranfasdfasf79ssdfffjmsdjkhsf1sklfske_wb&ids=µÚÒ»Çò&lx36=1');}	
}
...
function Loading_But(bid1,bID) {
    ...
    for (i=0;i<(mBut.length);i++){
        if (mBut[i] instanceof Array) {
		    ...
		    var Color_B = "";
		    if (mBut[i][0]=="Œ•rL†Î" || mBut[i][0]=="×Ô„ÓÑaØ›ÔO¶¨") Color_B = " class='font_r'";
