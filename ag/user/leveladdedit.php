...
$user_power=$_SESSION['user_power'.$c_p_seesion]; /*获取登陆的账号的级别*/
if ($_GET['top_id']) {
	$top_id=$_GET['top_id'];
}
// if ($top_id=='1') {
...
$top_oddsset1 =$db->get_all("select * from tuishui_set left join oddsset_type on tuishui_set.odds_id=oddsset_type.o_id where tuishui_set.user_id=".$_GET['user_id'].' and oddsset_type.user_id=0 order by tuishui_set.odds_id ASC');
