...
echo $user_char;
echo "名稱</td>\n                         <td bordercolor=\"#CCCCCC\" align=\"left\" bgcolor=\"#FFFFFF\" width=\"82%\"> <input name=\"user_nick\" class=\"input1\" id=\"xm\" value=\"";
echo $row['user_nick'];
...
echo "\"#FFFFFF\" width=\"82%\"> <input onKeyUp=\"To_RMB();\" name=\"credit_total\" class=\"input1\" id=\"cs\" value=\"";
...
echo "f=\"javascript:history.back(-1)\"><input name=\"cancel\" onclick=\"javascript:history.back(-1)\" value=\"取消\" class=\"btn2\" onmouseover=\"this.className='btn2m'\" onmouseout=\"this.className='btn2'\" type=\"button\"></a></td>\n                        </tr>\n                      </tbody>\n                    </table>\n                  </div>\n                  \n                  <!-- 結束  --></td>\n                <td backg";
